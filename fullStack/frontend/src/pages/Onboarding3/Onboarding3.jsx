...
import OnboardingForm3 from "../../components/componentsOnboarding3/OnboardingForm3";
        ...
        <div className="ob-header__top">
          ...
          <div className="ob-header__meta">
            <span className="ob-header__step">
              Paso <strong>3</strong> de 4
            </span>
          </div>
        </div>
        <div className="ob-progress">
          <div className="ob-progress__fill" style={{ transform: "scaleX(0.75)" }} />
        </div>
      </header>
